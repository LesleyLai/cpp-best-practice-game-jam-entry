...
// configuration step. It creates a namespace called `cpp-best-practice-game-jam-entry`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        cpp-best-practice-game-jam-entry::cmake::project_name,
        cpp-best-practice-game-jam-entry::cmake::project_version));// version string, acquired
